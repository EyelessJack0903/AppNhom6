...
public class ManagmentCart {
    private static final String SHARED_PREF_NAME_PREFIX = "cart_pref_user_";
    ...
    public ArrayList<Laptops> getListCart() {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHARED_PREF_NAME_PREFIX + currentUserUid, Context.MODE_PRIVATE);
    ...
    public void insertLaptop(Laptops laptop) {
        ...
        cart.add(laptop);
        saveListCart(cart); // Lưu danh sách giỏ hàng của id_User hiện tại vào SharedPreferences
    }
